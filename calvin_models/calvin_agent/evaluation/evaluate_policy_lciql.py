...
class CustomModel(CalvinBaseModel):
    def __init__(self, checkpoint_path, wandb_run_name):
        # Initialize LCBC
        self.lc_policy = lciql_policy.LCPolicy(checkpoint_path, wandb_run_name)
        ...
        self.log_dir = "/nfs/kun2/users/mitsuhiko/calvin-sim/experiments/diffusion_policy_experiments/lcbc"
